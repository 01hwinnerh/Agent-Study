...
questions = [
    "2025-06-16, 股市利好。股票优普教育A股今日开盘价66人民币，一度飙升至70人民币，随后回落至65人民币，最终以68人民币收盘，成交量达到123000。",
    "2025-06-06, 股市利好。股票黑马程序B-A股今日开盘价200人民币，一度飙升至211人民币，随后回落至201人民币，最终以206人民币收盘。"
]
...
for example in examples_data:
    ...
    messages.append(
        {"role":"assistant","content":json.dumps(example["answers"],ensure_ascii=False)}     #把字典转化为json对象（字符串）的形式
    )
for q in questions:
    ...
    #append()函数会永久修改messages中的内容，“ + ”只会在当轮短暂的创建一个新列表，并没有改变原来的messages
    # for x in messages:
    #     print(x)
